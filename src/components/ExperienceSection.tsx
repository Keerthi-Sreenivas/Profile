...
const experiences = [
  {
    ...
    description: "Solutions Architect specialising on AI Developer tooling. Achieved 150% product adoption and growth across 50+ customers and 3000+ developers through AI-driven developer productivity initiatives. Delivered enterprise solutions, resilience reviews, and tailored enablement sessions for AWS customers.",
    logo: awsLogo
  },
  {
