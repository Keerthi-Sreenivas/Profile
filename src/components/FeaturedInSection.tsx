              ...
              <div className="flex flex-col gap-3 md:gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                    ...
                    <h3 className="text-sm md:text-base font-semibold text-white group-hover:text-primary transition-colors duration-300 leading-tight">
                      {video.title}
                    </h3>
                  </div>
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-gradient-cosmic text-white font-medium rounded-lg hover:shadow-neon transition-all duration-300 text-xs"
                  >
